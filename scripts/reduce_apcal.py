...
bsp['fracpols'] = list(map(str,bsp.fracpols))
bsp['snrs'] = list(map(str,bsp.snrs))
bsp['amps'] = list(map(str,bsp.amps))
...
quad['snrs'] = list(map(str,quad.snrs))
quad['amps'] = list(map(str,quad.amps))
