...
def LCG_metric(obs,method='analytic',tavg=None,scan_avg=False,dummy_circ=True,dummy_zero=True,plot_solution=False,niter=200,specify_x0=None):
    #input:
    ...
    #dummy_zero: whether we should add dummy point at (u,v) = (0,0), strongly recommended
    ...
    #add dummy point at zero (recommended)
    if dummy_zero:
        uvecwork=np.array(list(uvecwork)+[0.0])
        vvecwork=np.array(list(vvecwork)+[0.0])
