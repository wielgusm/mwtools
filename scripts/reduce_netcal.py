...
data_subfolder='8.+netcal/'

print("Saving scan averaged data...")
#scan averaged data
out_name = 'net_sc'
importing.import_uvfits_set_netcal(path_data_0,data_subfolder,path_vex,path_out,out_name,tavg='scan',exptL=[3597,3598,3599,3600,3601],
    bandL=['lo','hi'],filend="netcal.uvfits",out_hdf=True)

print("Saving incoherently scan averaged data...")
#incoh scan averaged data
out_name = 'net_sc_incoh'
importing.import_uvfits_set_netcal(path_data_0,data_subfolder,path_vex,path_out,out_name,tavg='scan',exptL=[3597,3598,3599,3600,3601],
    bandL=['lo','hi'],filend="netcal.uvfits",incoh_avg=True,out_hdf=True)

print("Saving 10s data...")
#10s segmented data
out_name = 'net_10s'
importing.import_uvfits_set_netcal(path_data_0,data_subfolder,path_vex,path_out,out_name,tavg=-1,exptL=[3597,3598,3599,3600,3601],
    bandL=['lo','hi'],filend="netcal.uvfits",out_hdf=True)
